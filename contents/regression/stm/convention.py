...
def get_circ_coordinates():
    dictionary = {
        ...
        [
            [-0.199998, -0.030044, 0.035669],  # 겨드랑앞접힘점(Anterior Axillary Fold, 우)
            [-0.153927, -0.057942, 0.043028],
            [-0.141639, -0.061356, 0.046479],
            [-0.11131, -0.069076, 0.049282],
            [-0.074861, -0.075357, 0.047052],
            [-0.035686, -0.07915, 0.040907],
            [0.016632, -0.07921, 0.03546],
            [0.093635, -0.072639, 0.048794],
            [0.127369, -0.06516, 0.048404],
            [0.199999, -0.030045, 0.035673],  # 겨드랑앞접힘점(Anterior Axillary Fold, 좌)
            [0.222146, 0.082482, -0.004028],  # 겨드랑뒤접힘점(Posterior Axilla Fold, 좌)
            [0.193481, 0.109577, 0.056071],
            [0.169862, 0.117711, 0.051066],
            [0.138282, 0.131374, 0.043644],
            [0.098274, 0.144311, 0.032823],
            [0.055678, 0.144626, 0.024593],
            [-0.035268, 0.140073, 0.021464],
            [-0.098275, 0.14431, 0.032822],
            [-0.155596, 0.124445, 0.031299],
            [-0.222151, 0.082484, -0.004028],  # 겨드랑뒤접힘점(Posterior Axilla Fold, 우)
        ],
        'Bust Circumference':
        [
        ...
        [
            [-0.13146, -0.07267, -0.081184],  # 젖가슴아래수준(Inferior Breast level, 우)
            [-0.147679, -0.050131, -0.089314],
            [-0.163646, -0.01904, -0.091178],
            [-0.169702, 0.006676, -0.098635],
            [-0.171692, 0.032015, -0.101286],
            [-0.168645, 0.055796, -0.099064],
            [-0.141898, 0.098452, -0.103302],
            [-0.093254, 0.125282, -0.100086],
            [-0.041928, 0.130525, -0.109293],
            [0.041927, 0.130521, -0.109291],
            [-0.093254, 0.125282, -0.100086],
            [0.141898, 0.098452, -0.103302],
            [0.168645, 0.055796, -0.099064],
            [0.171692, 0.032015, -0.101286],
            ...
            [0.147679, -0.050131, -0.089314],
            [0.131466, -0.07268, -0.081184],  # 젖가슴아래수준(Inferior Breast level, 좌)
            [0.120527, -0.082122, -0.084175],
            [0.108965, -0.09081, -0.084813],
            [0.095528, -0.099048, -0.083856],
            [0.079537, -0.10603, -0.07936],
            [0.050461, -0.109182, -0.085502],
            [0.025572, -0.109489, -0.090275],
            [0.000005, -0.109004, -0.093552],
            [-0.025565, -0.109489, -0.090274],
            [-0.050461, -0.109182, -0.085502],
            [-0.079537, -0.10603, -0.07936],
            [-0.095528, -0.099048, -0.083856],
            [-0.108965, -0.09081, -0.084813],
